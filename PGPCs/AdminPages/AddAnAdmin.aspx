<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AddAnAdmin.aspx.cs" Inherits="AdminPages_AddAnAdmin" %>
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
                <asp:Button runat="server" OnClick="CreateUser_Click" Text="Add Admin" CssClass="btn btn-default" />
            </div>
        </div>
    </div>
</asp:Content>
